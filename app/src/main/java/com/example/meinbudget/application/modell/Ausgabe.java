...
public class Ausgabe implements Parcelable, AusgabeArtikel{
    ...
    public Ausgabe(int day, int month, int year, double value, int idCategory, String description, long idBudget) {
        this(-1, day, month, year, value, idCategory, description, idBudget);
    }

    public Ausgabe(long id, int day, int month, int year, double value, long idCategory, String description, long idBudget) {
        this(id, day, month, year, value, idCategory, description, -1, -1, idBudget);
    }

    public Ausgabe(long id, int day, int month, int year, double value, long idCategory, String description, @ColorInt int color, @DimenRes int icon, long idBudget) {
        this.id = id;
        this.day = day;
        this.month = month;
        this.year = year;
    ...
    public static final Parcelable.Creator<Ausgabe> CREATOR = new Parcelable.Creator<Ausgabe>() {
        @Override public Ausgabe createFromParcel(Parcel source) {
            return new Ausgabe(source);
        }

        @Override public Ausgabe[] newArray(int size) {
            return new Ausgabe[size];
        }
    };
